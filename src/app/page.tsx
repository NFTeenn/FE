...
import { DondonArtwork } from "@/shared/assets/dondon_artwork";
...
export default function Home() {
	return (
		<div className="flex w-[100vw] h-[100vh] relative pl-10 py-10 bg-white">
			<div className="flex justify-start items-end overflow-hidden basis-1/2 h-[90vh] bg-brand-main rounded-[12px]">
				<DondonArtwork className="w-full h-full" />
			</div>
